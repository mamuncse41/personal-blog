...
<body class="signup-body">
    <div class="agile-signup">	
       ...
       {!! Form::open(['url' => '','mathod'=>'post']) !!}
                <input type="text" name="Username" value="Username" onfocus="this.value = '';" onblur="if (this.value == '') {
                            this.value = 'Username';
                        }">
                <input type="tel" name="Phone" value="Phone" onfocus="this.value = '';" onblur="if (this.value == '') {
                            this.value = 'Phone';}">
             ...
             {!! Form::close() !!}
            <div class="">
                <p><a href="{{url('/admin_login')}}">Sign In</a></p>
            </div>
        ...
        <!-- footer -->
        <div class="copyright">
            <p>© 2018 All Rights Reserved . Develop by <a href="http://techmamun.com/">Tech Mamun</a></p>
        </div>
        <!-- //footer -->

    </div>
    <script src="{{url('public/Admin/js/proton.js')}}"></script>
</body>
</html>
